const PrinterServiceRequest = require('../../Models/serviceRequestModels/surveillanceServiceRequestModel');
...
const updateSurveillanceServiceStatus = async (req, res) => {
    try {
...
module.exports = {
    ...
    updateSurveillanceServiceStatus
}